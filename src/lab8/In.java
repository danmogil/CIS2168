...
/**
 * In. This class provides methods for reading strings and numbers from standard
 * input and file inputs.
 *
 * The Locale used is: language = English, country = US.
 *
 * Like Scanner, reading a token also consumes preceding Java whitespace,
 * reading a full line consumes the following end-of-line delimiter, while
 * reading a character consumes nothing extra.
 *
 * @author david Useful as a helper class for CIS-2168 demos and assignments.
 */
